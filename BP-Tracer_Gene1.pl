...
`mkdir -p $outdir/BP-Tracer_Gene_results`;
...
while($line=<IA>){
	...
	print OA "$Bin/bin/argoap_pipeline_stageone_version2.3 -i ./ -m meta-data.txt -o ./ -n $thread -f fq -z\n";
	close OA;
	...
	print OA "Kraken2 --db $Bin/PGtax --threads $thread --quick --report-zero-counts --gzip-compressed --paired --output $inf[0].readinfo --report $inf[0].report $inf[1] $inf[2]\n";
	print OA "python2 $Bin/bin/kraken2/kreport2mpa.py -r $inf[0].report -o $inf[0].mpa\n";
	print OA "python2 $Bin/bin/kraken2/est_abundance.py -t 1 -k $Bin/PGtax/database150mers.kmer_distrib -i $inf[0].report -o $inf[0].report.D -l D\n";
	print OA "python2 $Bin/bin/kraken2/est_abundance.py -t 1 -k $Bin/PGtax/database150mers.kmer_distrib -i $inf[0].report -o $inf[0].report.P -l P\n";
	print OA "python2 $Bin/bin/kraken2/est_abundance.py -t 1 -k $Bin/PGtax/database150mers.kmer_distrib -i $inf[0].report -o $inf[0].report.C -l C\n";
	print OA "python2 $Bin/bin/kraken2/est_abundance.py -t 1 -k $Bin/PGtax/database150mers.kmer_distrib -i $inf[0].report -o $inf[0].report.O -l O\n";
	print OA "python2 $Bin/bin/kraken2/est_abundance.py -t 1 -k $Bin/PGtax/database150mers.kmer_distrib -i $inf[0].report -o $inf[0].report.F -l F\n";
	print OA "python2 $Bin/bin/kraken2/est_abundance.py -t 1 -k $Bin/PGtax/database150mers.kmer_distrib -i $inf[0].report -o $inf[0].report.G -l G\n";
	print OA "python2 $Bin/bin/kraken2/est_abundance.py -t 1 -k $Bin/PGtax/database150mers.kmer_distrib -i $inf[0].report -o $inf[0].report.S -l S\n";
...
print OA "cp taxonomy.table\* $outdir/BP-Tracer_Gene_results\n";
close OA;
...
while($line=<IN>){
	...
	print OA "diamond blastx -d $Bin/PGfunc/MGE.dmnd -q $inf[1] -o $inf[0]_1.us -e 10 -p $thread -k 1 --id 60 --query-cover 15\n";
	print OA "diamond blastx -d $Bin/PGfunc/MGE.dmnd -q $inf[2] -o $inf[0]_2.us -e 10 -p $thread -k 1 --id 60 --query-cover 15\n";
	...
	print OA "$Bin/bin/merge_extracted_fa_update_metadate.v2.3.pl ./ ./ meta-data.txt meta_data_online.txt extracted.fa U $Bin/PGfunc/all_KO30_name.list\n";
	close OA;
	...
	print OA "diamond blastx -d $Bin/PGfunc/MRG.dmnd -q $inf[1] -o $inf[0]_1.us -e 10 -p $thread -k 1 --id 60 --query-cover 15\n";
	print OA "diamond blastx -d $Bin/PGfunc/MRG.dmnd -q $inf[2] -o $inf[0]_2.us -e 10 -p $thread -k 1 --id 60 --query-cover 15\n";
	print OA "$Bin/bin/extract_usearch_reads.pl $inf[0]_1.us $inf[1] $inf[0].extract_1.fa\n";
	print OA "$Bin/bin/extract_usearch_reads.pl $inf[0]_2.us $inf[2] $inf[0].extract_2.fa\n";
	print OA "$Bin/bin/merge_extracted_fa_update_metadate.v2.3.pl ./ ./ meta-data.txt meta_data_online.txt extracted.fa U $Bin/PGfunc/all_KO30_name.list\n";
	close OA;
	...
	print OA "diamond blastx -d $Bin/PGfunc/VFDB.dmnd -q $inf[1] -o $inf[0]_1.us -e 10 -p $thread -k 1 --id 60 --query-cover 15\n";
	print OA "diamond blastx -d $Bin/PGfunc/VFDB.dmnd -q $inf[2] -o $inf[0]_2.us -e 10 -p $thread -k 1 --id 60 --query-cover 15\n";
	print OA "$Bin/bin/extract_usearch_reads.pl $inf[0]_1.us $inf[1] $inf[0].extract_1.fa\n";
	print OA "$Bin/bin/extract_usearch_reads.pl $inf[0]_2.us $inf[2] $inf[0].extract_2.fa\n";
	print OA "$Bin/bin/merge_extracted_fa_update_metadate.v2.3.pl ./ ./ meta-data.txt meta_data_online.txt extracted.fa U $Bin/PGfunc/all_KO30_name.list\n";
	close OA;
