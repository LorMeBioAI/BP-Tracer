...
while($line=<IA>){
	...
	if($n % $pn ==0){
		...
		print OB "blastx -query $outdir/temp/01.ARG/temp.$n.fa -out $outdir/temp/01.ARG/temp.$n.fa.m8 -db $Bin/PGfunc/ARG-uniq.fa -evalue 1e-7  -num_threads 4 -outfmt 6 -max_target_seqs 1\n";
		close OB;
...
print OO "$Bin/bin/argoap_pipeline_stagetwo_version2 -i $outdir/temp/01.ARG/extracted.fa -m $outdir/temp/01.ARG/meta_data_online.txt -n $thread -o $outdir/temp/01.ARG/ARG-OUT -b $outdir/temp/01.ARG/blastx.out\n";
print OO "cp $outdir/temp/01.ARG/ARG-OUT\*.txt $outdir/BP-Tracer_Gene_results\n";
print OO "cd $outdir/BP-Tracer_Gene_results\n";
print OO "perl $Bin/bin/geneppm-extract.pl $Bin/bin/species.txt $Bin/PGfunc/ARG-uniq.list taxonomy.table.S ARG-OUT.ppm.gene.txt ARG-Tax.ppm.gene.txt\n";
close IA;
close OA;
close OO;
...
while($line=<IA>){
	...
	if($n % $pn ==0){
		...
		print OB "blastx -query $outdir/temp/02.MGE/temp.$n.fa -out $outdir/temp/02.MGE/temp.$n.fa.m8 -db $Bin/PGfunc/MGE-uniq.fa -evalue 1e-7  -num_threads 4 -outfmt 6 -max_target_seqs 1\n";
		close OB;
...
print OO "$Bin/bin/MGE_stagetwo -i $outdir/temp/02.MGE/extracted.fa -m $outdir/temp/02.MGE/meta_data_online.txt -n $thread -o $outdir/temp/02.MGE/MGE-OUT -b $outdir/temp/02.MGE/blastx.out\n";
print OO "cp $outdir/temp/02.MGE/MGE-OUT\*.txt $outdir/BP-Tracer_Gene_results\n";
print OO "cd $outdir/BP-Tracer_Gene_results\n";
print OO "perl $Bin/bin/geneppm-extract.pl $Bin/bin/species.txt $Bin/PGfunc/MGE-uniq.list taxonomy.table.S MGE-OUT.ppm.gene.txt MGE-Tax.ppm.gene.txt\n";
close IA;
close OA;
close OO;
...
while($line=<IA>){
	...
	if($n % $pn ==0){
		...
		print OB "blastx -query $outdir/temp/03.MRG/temp.$n.fa -out $outdir/temp/03.MRG/temp.$n.fa.m8 -db $Bin/PGfunc/MRG-uniq.fa -evalue 1e-7  -num_threads 4 -outfmt 6 -max_target_seqs 1\n";
		close OB;
...
print OO "$Bin/bin/MRG_stagetwo -i $outdir/temp/03.MRG/extracted.fa -m $outdir/temp/03.MRG/meta_data_online.txt -n $thread -o $outdir/temp/03.MRG/MRG-OUT -b $outdir/temp/03.MRG/blastx.out\n";
print OO "cp $outdir/temp/03.MRG/MRG-OUT\*.txt $outdir/BP-Tracer_Gene_results\n";
print OO "cd $outdir/BP-Tracer_Gene_results\n";
print OO "perl $Bin/bin/geneppm-extract.pl $Bin/bin/species.txt $Bin/PGfunc/MRG-uniq.list taxonomy.table.S MRG-OUT.ppm.gene.txt MRG-Tax.ppm.gene.txt\n";
close IA;
close OA;
close OO;
...
while($line=<IA>){
	...
	if($n % $pn ==0){
		...
		print OB "blastx -query $outdir/temp/04.VFDB/temp.$n.fa -out $outdir/temp/04.VFDB/temp.$n.fa.m8 -db $Bin/PGfunc/VFDB-uniq.fa -evalue 1e-7  -num_threads 4 -outfmt 6 -max_target_seqs 1\n";
		close OB;
...
print OO "$Bin/bin//VFDB_stagetwo -i $outdir/temp/04.VFDB/extracted.fa -m $outdir/temp/04.VFDB/meta_data_online.txt -n $thread -o $outdir/temp/04.VFDB/VFDB-OUT -b $outdir/temp/04.VFDB/blastx.out\n";
print OO "cp $outdir/temp/04.VFDB/VFDB-OUT\*.txt $outdir/BP-Tracer_Gene_results\n";
print OO "cd $outdir/BP-Tracer_Gene_results\n";
print OO "perl $Bin/bin/geneppm-extract.pl $Bin/bin/species.txt $Bin/PGfunc/VFDB-uniq.list taxonomy.table.S VFDB-OUT.ppm.gene.txt VFDB-Tax.ppm.gene.txt\n";
close IA;
close OA;
close OO;
